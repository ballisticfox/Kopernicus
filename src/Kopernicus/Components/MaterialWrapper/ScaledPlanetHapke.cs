...
namespace Kopernicus.Components.MaterialWrapper
{
    ...
    public class ScaledPlanetHapke : Material
    {
        // Internal property ID tracking object
        protected class Properties
        {
            // Return the shader for this wrapper
            private const String SHADER_NAME = "Terrain/HapkeSpecular";
            ...
            public const String mTheta_KEY = "_mTheta";
            public Int32 mThetaId { get; private set; }
            ...
            public const String SPECCOLOR_KEY = "_specColor";
            public Int32 specColorId { get; private set; }

            public const String N_KEY = "_n";
            public Int32 nId { get; private set; }
            ...
            private Properties()
            {
                ...
                mThetaId = Shader.PropertyToID(mTheta_KEY);
                specColorId = Shader.PropertyToID(SPECCOLOR_KEY);
                nId = Shader.PropertyToID(N_KEY);
        ...
        public Single mTheta
        {
            get { return GetFloat(Properties.Instance.mThetaId); }
            set { SetFloat(Properties.Instance.mThetaId, value); }
        }
        public Single L
        {
        ...
        public Single N
        {
            get { return GetFloat(Properties.Instance.nId); }
            set { SetFloat(Properties.Instance.nId, value); }
        }
        ...
        public ScaledPlanetHapke() : base(Properties.Shader)
        {
        }

        [Obsolete("Creating materials from shader source String is no longer supported. Use Shader assets instead.")]
        public ScaledPlanetHapke(String contents) : base(contents)
        {
            shader = Properties.Shader;
        }

        public ScaledPlanetHapke(Material material) : base(material)
        {
